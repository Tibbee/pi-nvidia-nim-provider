...
| GLM-5.3 Flash | low / high / max (exactly three levels); always-on; image input | `reasoning_effort` (probe-passed) | `reasoning_content` (probe-passed) | probe-passed | probe-passed |
