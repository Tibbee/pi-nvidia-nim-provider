...
- [x] Keep model routing and thinking dispatch in sync.

## P1 — Testing
- [x] Add unit tests for `handlers/thinking.ts`.
- [x] Add snapshot tests for `before_provider_request` payload rewrites.
...
## P2 — Maintainability
- [x] Reduce duplicated regex logic between `MODEL_FAMILIES` and `classifyThinkingFormat()`.
